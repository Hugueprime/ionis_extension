var dates = {
    "epita_maths_s1":[
        {"start": new Date('2021-09-01'), "end": new Date('2021-09-30')},
        {"start": new Date('2021-09-01'), "end": new Date('2021-09-30')},
        {"start": new Date('2021-09-01'), "end": new Date('2021-09-30')},
        {"start": new Date('2021-09-01'), "end": new Date('2021-09-30')},
        {"start": new Date('2021-09-01'), "end": new Date('2021-09-30')},
        ...
        {"start": new Date('2021-09-01'), "end": new Date('2021-09-30')},
        {"start": new Date('2021-09-01'), "end": new Date('2021-09-30')},
        {"start": new Date('2021-09-01'), "end": new Date('2021-09-30')},//15
        {"start": new Date('2021-10-04'), "end": new Date('2021-10-10')},
        ...
        {"start": new Date('2021-11-22'), "end": new Date('2021-11-28')},
        {"start": new Date('2021-11-29'), "end": new Date('2021-12-05')},
        {"start": new Date('2021-12-06'), "end": new Date('2021-12-12')}
    ],
    "epita_algorithmique_s1_et_s1":[
        {"start": new Date('2021-09-27'), "end": new Date('2021-10-04')},
        {"start": new Date('2021-10-11'), "end": new Date('2021-10-24')},
        {"start": new Date('2021-10-25'), "end": new Date('2021-10-31')},
        {"start": new Date('2021-11-15'), "end": new Date('2021-11-21')},
        {"start": new Date('2021-11-15'), "end": new Date('2021-11-21')},//5
        {"start": new Date('2021-11-22'), "end": new Date('2021-11-28')},
        {"start": new Date('2021-11-22'), "end": new Date('2021-11-28')},
        {"start": new Date('2021-11-29'), "end": new Date('2021-12-05')},
        {"start": new Date('2021-11-29'), "end": new Date('2021-12-05')},
        {"start": new Date('2021-12-06'), "end": new Date('2021-12-12')},//10
        {"start": new Date('2021-12-06'), "end": new Date('2021-12-12')},
        {"start": new Date('2021-12-13'), "end": new Date('2021-12-19')},
    ],
    "epita_maths_s2":[
        {"start": new Date('2024-01-01'), "end": new Date('2024-01-01')},//Introduction aux polynômes
        {"start": new Date('2024-01-01'), "end": new Date('2024-01-01')},//Division euclidienne
        {"start": new Date('2024-01-01'), "end": new Date('2024-01-01')},//Racine d’un polynôme et factorisation
        {"start": new Date('2022-01-10'), "end": new Date('2022-01-16')},//Equations différentielles linéaires du premier ordre
        {"start": new Date('2022-01-10'), "end": new Date('2022-01-16')},//5 //Equations différentielles linéaires du second ordre
        {"start": new Date('2024-01-01'), "end": new Date('2024-01-01')},//Continuité en un point
        {"start": new Date('2024-01-01'), "end": new Date('2024-01-01')},//Continuité sur un intervalle
        {"start": new Date('2022-01-17'), "end": new Date('2022-01-23')},//Formules de Taylor
        {"start": new Date('2022-01-17'), "end": new Date('2022-01-23')},//Développements limités au voisinage d'un point
        {"start": new Date('2022-01-24'), "end": new Date('2022-01-30')},//10 Opérations sur les développements limités
        {"start": new Date('2022-01-31'), "end": new Date('2022-02-06')},//Introduction aux espaces vectoriels
        {"start": new Date('2022-01-31'), "end": new Date('2022-02-06')},//Propriétés d’un espace vectoriel
        {"start": new Date('2022-01-31'), "end": new Date('2022-02-06')},//Définition d’un sous-espace vectoriel
        {"start": new Date('2022-02-07'), "end": new Date('2022-02-13')},//Combinaisons linéaires, caractérisation et intersection d’espaces vectoriels
        {"start": new Date('2022-02-07'), "end": new Date('2022-02-13')},//15 Somme, sous-espace vectoriel engendré
        {"start": new Date('2022-02-07'), "end": new Date('2022-02-13')},//Famille libre
        {"start": new Date('2022-02-14'), "end": new Date('2022-02-20')},//Famille génératrice
        {"start": new Date('2022-02-14'), "end": new Date('2022-02-20')},//Base
        {"start": new Date('2022-02-14'), "end": new Date('2022-02-20')},//Dimension d'un espace vectoriel
